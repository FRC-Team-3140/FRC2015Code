...
public class OI {
    ...
    public static double abs(double rawJoystickValue) {
		return 0;
	}
    ...
    public double getRightDriveAxis() {
        if (joystick.length > 1) {
        	speedMultiplier = joystick[0].getRawAxis(3);
    ...
    public boolean isInLowGear() {
   	...
   	public boolean getGrabberStopButton() {
   		return !(getGrabberOpenButton() | getGrabberCloseButton());
   	}
}
