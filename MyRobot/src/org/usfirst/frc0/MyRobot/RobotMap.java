...
public class RobotMap {
    ...
    public static final int driveTrainLeftMotorPin = 0;
    public static final int driveTrainRightMotorPin = 1;
    // solenoid pins
    public static final int compressorPin = 0;
    
    public static void init() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        driveTrainLeftMotor = new Talon(driveTrainLeftMotorPin);
        LiveWindow.addActuator("driveTrain", "Left Motor", (Talon) driveTrainLeftMotor);
        
        driveTrainRightMotor = new Talon(driveTrainRightMotorPin);
